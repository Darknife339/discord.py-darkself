...
class MyClient(discord_self.Client):
    async def on_ready(self):
        ...
        activity = discord_self.Activity(
            type=discord_self.ActivityType.playing,
            application_id=APPLICATION_ID,
            name='name',
            details='details',
            state='state',
            assets=discord_self.ActivityAssets(
            ...
            buttons=[
                discord_self.ActivityButton('Website', 'https://example.com'),
            ],
        )
