...
# These dependencies are not automatically included with discord_self.py and need to be installed separately:
...
async def show_captcha(exc: discord_self.CaptchaRequired, client: commands.Bot) -> str:
    ...
    config = {
        'sitekey': exc.sitekey,
        'rqdata': exc.rqdata,
        'url': 'https://discord_self.com/channels/@me',
    }
